 ...
 protected void onCreate(Bundle savedInstanceState) 
{
    ...
    AbsListView absListView = (AbsListView) findViewById(R.id.image_grid_view);

    if (absListView == null) toast ("Unable to find GridView");
    else {
         absListView.setAdapter (new ImageCellAdapter(this));
    ...
    mDragLayer.setAbsListView (absListView);
