...
/**
 * This class is used with a AbsListView object. It provides a set of ImageCell objects 
...
/**
 * getView
 * Return a view object for the absListView.
 * 
 * @return ImageCell
 */
public View getView (int position, View convertView, ViewGroup parent) 
{
    ...
    if (convertView == null) {
        ...
        v.setLayoutParams(new AbsListView.LayoutParams(85, 85));
